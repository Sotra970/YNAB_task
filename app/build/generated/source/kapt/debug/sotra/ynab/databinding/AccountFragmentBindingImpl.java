...
public class AccountFragmentBindingImpl extends AccountFragmentBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.retryCallback == variableId) {
            ...
            setAdapter((sotra.ynab.ui.accountsFragment.AccountsAdapter) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((sotra.ynab.ui.accountsFragment.AccountViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable sotra.ynab.ui.accountsFragment.AccountsAdapter Adapter) {
    ...
    public void setViewModel(@Nullable sotra.ynab.ui.accountsFragment.AccountViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        sotra.ynab.ui.accountsFragment.AccountsAdapter adapter = mAdapter;
        java.lang.Boolean viewModelNetworkStatusGetValue = null;
        sotra.ynab.ui.accountsFragment.AccountViewModel viewModel = mViewModel;
